...
pub fn run() {
    ...
    let run_result = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::load_agent_context_panel,
            commands::save_agent_context_panel_config,
            commands::load_agent_context_access_policy,
            commands::update_agent_context_access_policy,
